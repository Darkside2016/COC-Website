...
<?php
	...
	include_once ("".$gbook_folder."/gbook.head.php");			//nicht ändern
 ?>
<?php
...
<head>
	...
	<link rel="stylesheet" href="codex/gbock.css" type="text/css"/>
...
<br /><br />
        ...
        <div class="gbook">
	<div class="gbook-wrapper"><a id="anchor-gbooktop" name="anchor-gbooktop"></a>
	<p>&nbsp;</p>
	<?php
		include_once ("".$gbook_folder."/gbook.body.php");			//nicht ändern
	?>
        </div>
	</div>
